...
using OpenGate.STS.Identity.Configuration.ApplicationParts;
using OpenGate.STS.Identity.Configuration.Constants;
using OpenGate.STS.Identity.Configuration.Interfaces;
using OpenGate.STS.Identity.Helpers.Localization;
using OpenGate.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using OpenGate.Admin.EntityFramework.MySql.Extensions;
using OpenGate.Admin.EntityFramework.PostgreSQL.Extensions;
using OpenGate.Admin.EntityFramework.Shared.Configuration;
using OpenGate.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace OpenGate.STS.Identity.Helpers
{
